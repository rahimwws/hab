...
import { HabitSheet } from '@/src/shared/ui/BottomSheet/idnex'
import { BottomSheetModal } from '@gorhom/bottom-sheet'
import { useCounterState } from '../lib/state/counterState'
import { useHabitStore } from '../../habit/lib/state/HabitStore'
import { LargeButton } from '@/src/shared/ui/Buttons'
import { Typography } from '@/src/shared/ui/Typography'
import * as ProgressBar from 'react-native-progress';
import colors from '@/src/shared/lib/theme/colors'
import { Award } from '@/src/shared/assets'
import { ProgressFormat } from '../../habit/lib/format/ProgressFormat'
...
const CounterSheet = () => {
    ...
    return (
        <HabitSheet ref={bottomSheetRef} title="Daily Update" action={closeSheet}>
            <Typography align="left" color="primary400" font='p-sb' size={22} styles={{ marginVertical: 10 }}>
            ...
            <View style={{ alignSelf: "flex-end", width: "100%", marginTop: "auto", marginBottom: 20 }}>
                <LargeButton text='Detail' isRoute={false} action={() => updateCounter(1)} heptic={true} violet={false} />
                <LargeButton text='Add +1' isRoute={false} action={() => updateCounter(1)} heptic={true} />
            </View>
        </HabitSheet>
    );
};
