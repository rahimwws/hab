...
const Award = ({ color = colors.gray400 }: { color?: string }) => {
  return (
    <Svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      />
      <Path
        d="M5.95825 18.3333H14.2916V17.4999C14.2916 16.5833 13.5416 15.8333 12.6249 15.8333H7.62492C6.70825 15.8333 5.95825 16.5833 5.95825 17.4999V18.3333V18.3333Z"
        stroke={color}
        strokeWidth="1.3"
        stroke-miterlimit="10"
      />
      <Path
        d="M5.125 18.3333H15.125"
        stroke={color}
        strokeWidth="1.3"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <Path
        d="M10.0001 13.3334C6.77508 13.3334 4.16675 10.7251 4.16675 7.50008V5.00008C4.16675 3.15841 5.65841 1.66675 7.50008 1.66675H12.5001C14.3417 1.66675 15.8334 3.15841 15.8334 5.00008V7.50008C15.8334 10.7251 13.2251 13.3334 10.0001 13.3334Z"
        stroke={color}
        strokeWidth="1.3"
        stroke-linecap="round"
        stroke-linejoin="round"
